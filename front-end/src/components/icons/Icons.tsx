...
export function LogoIcon({ size = 28, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <defs>
        <linearGradient id="vitalfit-grad" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
          <stop stopColor="#10b981" />
          <stop offset="1" stopColor="#06b6d4" />
        </linearGradient>
      </defs>
      <rect width="32" height="32" rx="9" fill="url(#vitalfit-grad)" />
      <path
        d="M8 17L12 17L14.5 10L18 22L20.5 15L24 15"
        stroke="#ffffff"
        strokeWidth="2.5"
        strokeLinecap="round"
...
export function DumbbellIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m6.5 6.5 11 11" />
      <path d="m21 21-1-1a2 2 0 0 0-2.8 0L16 21" />
      <path d="m3 3 1 1a2 2 0 0 0 2.8 0L8 3" />
